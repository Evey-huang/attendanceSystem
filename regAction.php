...
//             echo "<script>alert('账户已存在');window.location.href='register.html';</script>";
//         }
//         else{
...
//             }
//             else{
//                 echo "<script>alert('服务器繁忙');window.location.href='register.html';</script>";
//             }
//         }
//     }
//     else {
//         echo "<script>alert('两次密码不一致');window.location.href='register.html';</script>";
//     }
// }
$name = $_POST['username'];
$pwd= $_POST['pwd'];
